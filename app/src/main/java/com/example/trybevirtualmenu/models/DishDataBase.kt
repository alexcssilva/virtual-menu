    ...
    private val foods = listOf<Dish>(
        Dish(
            ...
            "Uma suculenta porção de filé de carne grelhado na perfeição," +
                    " servido com deliciosas batatas fritas crocantes." +
        ...
        Dish(
            ...
            "Uma opção saudável e saborosa: " +
                    "peitos de frango suculentos grelhados à perfeição," +
                    " acompanhados de legumes frescos, preparados para manter" +
        ...
        Dish(
            ...
            R.drawable.prato_03,
            "A melhor escolha para os indecisos! " +
                    "Uma combinação harmoniosa de filé de carne suculento e peito de frango grelhado," +
                    "oferecendo uma explosão de sabores em cada garfada. " +
        ...
        Dish(
            ...
            "Para os amantes de batatas, esta é a escolha ideal. " +
                    "Nossas batatas fritas são cortadas e preparadas na hora para " +
                    "garantir a crocância perfeita. " +
                    "Acompanhadas de uma variedade de molhos incríveis que vão " +
                    "tornar cada mordida ainda mais especial. " +
        ...
        Dish(
            ...
            "Um gole de pura refrescância e vitalidade." +
                    "Nosso suco de laranja é feito com as laranjas mais suculentas e frescas, " +
                    "espremidas na hora para garantir o sabor cítrico " +
                    "e natural que todos adoram." +
                    "Perfeito para acompanhar suas refeições ou para " +
                    "matar a sede a qualquer hora do dia. " +
